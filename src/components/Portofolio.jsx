...
const Portofolio = () => {
  return (
    <div className='porto-cont'>
        ...
        <div>
            <div className="work1 pro"></div>
            <div className="work2 pro"></div>
            <div className="work3 pro"></div>
        </div>
        </div>
        <h1 className='exp-title'>Experience Work with Clients <br />Around the World</h1>
